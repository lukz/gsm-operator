...
Shader "Custom/BlendModeShader2D/SpriteBlendModeSharedGrab"
 {
	Properties
	{
	...
	SubShader 
	{
		...
		GrabPass {"_SpriteBackgroundTexture"}
		...
		Pass
		{
			...
			float4 _MainTex_ST;
			fixed4 _Color;
			sampler2D _SpriteBackgroundTexture;
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				fixed4 grabColor = tex2D(_SpriteBackgroundTexture, i.screenWPos.xy) * _BaseLayerColor; 
