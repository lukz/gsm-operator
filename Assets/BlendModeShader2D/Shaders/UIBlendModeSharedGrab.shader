Shader "Custom/BlendModeShader2D/UIBlendModeSharedGrab" 
{
	Properties
	{
		[PerRendererData] 
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _ClipRect;
			sampler2D _UIBackgroundTexture;
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				fixed4 grabColor = tex2D(_UIBackgroundTexture, i.screenWPos.xy) * _BaseLayerColor; 
